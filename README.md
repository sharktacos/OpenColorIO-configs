...
OCIO Configs are provided for an ACES workflow for both [CG Animation and VFX pipelines](configs.md). Each of these configs (ANM and VFX) has versions v1 and v2 of OCIO. Currently only Maya 2022 can read a v2 OCIO config. 
